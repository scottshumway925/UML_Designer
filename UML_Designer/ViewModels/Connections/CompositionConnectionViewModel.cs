...
namespace UML_Designer.ViewModels.Connections
{
   public class CompositionConnectionViewModel : ConnectionsBaseViewModel
   {
      ...
      protected override string typeOfConn => "Composition";
      public override IBrush FillColor => _isSelected ? Brushes.Blue : Brushes.Black;
      ...
      protected override List<Point> SetLines()
      {
         ...
         if (_parent.X + _parent.GetWidth() < _child.X)
         {
            ...
            return new List<Point>
            {
               new Point(_parent.X + _parent.GetWidth(), midParentY),
